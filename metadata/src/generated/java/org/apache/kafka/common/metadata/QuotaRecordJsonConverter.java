...
import static org.apache.kafka.common.metadata.QuotaRecord.*;
    ...
    public static QuotaRecord read(JsonNode _node, short _version) {
        ...
        if (_entityNode == null) {
            ...
            if (!_entityNode.isArray()) {
                throw new RuntimeException("QuotaRecord expected a JSON array, but got " + _node.getNodeType());
            }
        ...
        if (_keyNode == null) {
            ...
            if (!_keyNode.isTextual()) {
                throw new RuntimeException("QuotaRecord expected a string type, but got " + _node.getNodeType());
            }
        ...
        if (_removeNode == null) {
            ...
            if (!_removeNode.isBoolean()) {
                throw new RuntimeException("QuotaRecord expected Boolean type, but got " + _node.getNodeType());
            }
